...
//            }
        	...
        	DoubleColumn theS4 =(DoubleColumn)diabetesData.nCol("S4");
        	DoubleColumn theBMI =(DoubleColumn)diabetesData.nCol("BMI");
        	
        	Table heatMapTable = Table.create("heatMapTable", theS1, theS2, theS3, theS4,theBMI);
            ...
            frame.getContentPane().add(Heatmap.plot(heatMapTableArr,Palette.jet(256)));
